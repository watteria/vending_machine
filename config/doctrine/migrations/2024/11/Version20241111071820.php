...
final class Version20241111071820 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE coins (coin_id CHAR(250) NOT NULL, quantity INT(20) NOT NULL,  coin_value FLOAT(20) NOT NULL,valid_for_change INT(1), PRIMARY KEY(coin_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
