Feature: Get Customer from the API

  Scenario: Verify fields in customer response
    ...
    And the database contains this coins:
      ...
      """
    When I send a GET request to "/api/customers/3f487129-f7b9-4bbf-b6f3-7925c433d635"
